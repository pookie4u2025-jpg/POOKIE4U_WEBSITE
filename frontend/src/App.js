  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <nav className="fixed top-0 w-full bg-black/80 backdrop-blur-md z-50 border-b border-gray-800">
        ...
        {/* Mobile Menu */}
        {mobileMenuOpen && (
          <div className="md:hidden bg-gray-900 border-t border-gray-800" data-testid="mobile-menu">
            <div className="px-4 py-4 space-y-4">
              ...
              <a 
                href="#download" 
                className="block bg-pink-500 hover:bg-pink-600 px-6 py-2 rounded-full transition text-center"
                onClick={() => setMobileMenuOpen(false)}
              >
                Download
              </a>
